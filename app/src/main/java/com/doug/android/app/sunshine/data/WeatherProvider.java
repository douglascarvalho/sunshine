 ...
 */
package com.doug.android.app.sunshine.data;
...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(WeatherContract.CONTENT_AUTHORITY, WeatherContract.PATH_WEATHER.concat("/*"), WEATHER_WITH_LOCATION);
        uriMatcher.addURI(WeatherContract.CONTENT_AUTHORITY, WeatherContract.PATH_WEATHER.concat("/*/#"), WEATHER_WITH_LOCATION_AND_DATE);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        final int match = sUriMatcher.match(uri);
        if ( null == selection ) selection = "1"; // to delete all rows
        int rowsDeleted;
        switch (match){
            case WEATHER: {
