...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        // query if you like)
        assertEquals(testValues.get(WeatherContract.LocationEntry.COLUMN_CITY_NAME), c.getString(2));

        TestUtilities.validateCurrentRecord("Error validante records", c, testValues);
    ...
    private void insertLocationEntry() {
    }
    ...
    public void testWeatherTable() {
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error validante records",c,weatherValues);
